 ...
 * @author THEOLDISBACK
 */
public class ajouterdechetfrontController implements Initializable {
...
Categorie thiscategorie;
    ...
    private void ajouterdechet(ActionEvent event) throws IOException {
                            System.out.println(""+""+this.thisbac.getId());
    ...
    ip= Integer.parseInt(quantite.getText());
          ...
          Alert a = new Alert(Alert.AlertType.INFORMATION, "quantite cant be string");
               ...
               if (ab==0)
               {
                    ...
                    System.out.println(this.thisbac.getId()+this.thiscategorie.getId());
        s.ajouterdechet(new Dechet(1, q, new Date(199993010),thiscategorie.getId(),thisbac.getId()));
                        ...
                        a.show();
                          ...
                          anchorme.setVisible(false);
                           ...
                           FXMLLoader load = new FXMLLoader(getClass().getResource("/edu/devapps/Interface/frontbac.fxml"));
                           Parent root =load.load();
                           FrontbacController c2=  load.getController();
