   ...
   Categorie thiscat;
    ...
    private void modifiercategorie(ActionEvent event) throws IOException {
        ...
        CategorieService s = new CategorieService();
                s.modifiercategorie(new Categorie(thiscat.getId(), nom.getText(), description.getText()));
     ...
     public void setData(Categorie newcat) {
        this.thiscat = newcat;
 
        nom.setText(newcat.getNom());
        description.setText(newcat.getDescription());
