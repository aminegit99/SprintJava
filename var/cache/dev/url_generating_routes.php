...
return [
    'app_accessdenied' => [[], ['_controller' => 'App\\Controller\\AccessdeniedController::index'], [], [['text', '/access_denied']], [], [], []],
    ...
    'app_verify_email2' => [[], ['_controller' => 'App\\Controller\\RegistrationController::verifyUserEmail'], [], [['text', '/verify/email2']], [], [], []],
    ...
    'bymail' => [[], ['_controller' => 'App\\Controller\\UserController::listUserByEmail'], [], [['text', '/user/bymail']], [], [], []],
    'byusername' => [[], ['_controller' => 'App\\Controller\\UserController::listUserByUsername'], [], [['text', '/user/byusername']], [], [], []],
    'listUserVerified' => [[], ['_controller' => 'App\\Controller\\UserController::listUserVerified'], [], [['text', '/user/listUserVerified']], [], [], []],
    'listUserBanned' => [[], ['_controller' => 'App\\Controller\\UserController::listUserBanned'], [], [['text', '/user/listUserBanned']], [], [], []],
    ...
    'app_user_edit_roles' => [['id'], ['_controller' => 'App\\Controller\\UserController::editUserRoles'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/user/editroles']], [], [], []],
    'user_ban' => [['id'], ['_controller' => 'App\\Controller\\UserController::ban'], [], [['text', '/ban'], ['variable', '/', '[^/]++', 'id', true], ['text', '/user']], [], [], []],
    'user_unban' => [['id'], ['_controller' => 'App\\Controller\\UserController::unban'], [], [['text', '/unban'], ['variable', '/', '[^/]++', 'id', true], ['text', '/user']], [], [], []],
