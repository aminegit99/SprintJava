...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'fullname', '' . "\0" . 'App\\Entity\\User' . "\0" . 'naissance', '' . "\0" . 'App\\Entity\\User' . "\0" . 'isVerified', '' . "\0" . 'App\\Entity\\User' . "\0" . 'isBanned', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNaissance(\DateTimeInterface $naissance): \App\Entity\User
    {
